...
<section id="content">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col_one_third">
						<div class="feature-box fbox-center fbox-outline fbox-effect nobottomborder">
							<div class="fbox-icon">
								<a href="#"><i class="icon-picture i-alt"></i></a>
							</div>
							<h3>Portrait/Lifestyle Photography</h3>
						</div>
					</div>
					...
					<div class="col_one_third">
						<div class="feature-box fbox-center fbox-outline fbox-effect nobottomborder">
							<div class="fbox-icon">
								<a href="#"><i class="icon-building i-alt"></i></a>
							</div>
					...
					<div class="pricing bottommargin clearfix">
						...
						<div class="col-md-4">
							...
							<div class="pricing-box">
								...
								<div class="pricing-price">
									<span class="price-unit">Rs.</span>7<span class="price-tenure">/mo</span>
								</div>
						...
						<div class="col-md-4">
							...
							<div class="pricing-box best-price">
								...
								<div class="pricing-price">
									<span class="price-unit">Rs.</span>12<span class="price-tenure">/mo</span>
								</div>
								<div class="pricing-features">
									<ul>
										<li><strong>Full</strong> Access</li>
								...
								<div class="pricing-action">
									<a href="#" class="btn btn-danger btn-block btn-lg bgcolor border-color">Contact Us</a>
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="pricing-box">
								...
								<div class="pricing-price">
									<span class="price-unit">Rs.</span>19<span class="price-tenure">/mo</span>
								</div>
								<div class="pricing-features">
									<ul>
										<li><strong>Full</strong> Access</li>
				...
				<div class="promo promo-dark promo-flat promo-full topmargin footer-stick">
					<div class="container clearfix">
						<h3>Contact us NOW and we will create MEMORIES for you!  </h3>
						<a href="contact.php" class="button button-xlarge button-rounded">Click Here to drop us your enquiry.</a>
					</div>
				</div>

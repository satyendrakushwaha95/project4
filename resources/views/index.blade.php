...
<section id="slider" class="slider-parallax revslider-wrap clearfix">
	<div class="slider-parallax-inner">
		...
		<div class="tp-banner-container rev_slider_wrapper fullscreen-container">
			<div class="tp-banner" >
				<ul>    <!-- SLIDE  -->
					<li class="dark" data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb="images/slider/rev/main/s1-thumb.jpg"  data-saveperformance="off"  data-title="Welcome to Memories">
						<!-- MAIN IMAGE -->
						...
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap;">Prepare to smile and laugh out loud.</div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap;">Welcome to the World of Memories</div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 3; width: 750px; max-width: 750px; white-space: normal;">Create a world that you are gonna be proud of. Be it Portrait, Lifestyle, Commercial, Events &amp; much more..</div>
					...
					<li class="dark" data-transition="slideup" data-slotamount="1" data-masterspeed="1000" data-thumb="images/slider/rev/main/s2-thumb.jpg"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off" data-title="Shed a few Tears">
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 11; white-space: nowrap;">Get Ready to Shed a few Tears</div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 11; font-size: 56px;white-space: nowrap;">25+ Events</div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 11; max-width: 550px; white-space: normal;">See your story created by the talented team of Shutter Up Photo & Films..</div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1300"
						data-endeasing="Power4.easeIn" style="z-index: 11;"><a href="services.php" class="button button-border button-white button-light button-large button-rounded tright nomargin"><span>Check Now</span> <i class="icon-angle-right"></i></a></div>

					</li>
					<li data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-thumb="images/slider/rev/main/s3-thumb.jpg" data-delay="10000"  data-saveperformance="off"  data-title="Deliver Quality">
						<!-- MAIN IMAGE -->
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap; color: #222;">We Consistently Deliver Quality</div>
						...
						data-endelementdelay="0.1"
						data-endspeed="1000"
						data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap; color: #222; line-height: 1.2; max-width: 450px; width: 450px; white-space: normal;">Covering all genres of photography</div>
...
<!-- <div class="row common-height clearfix">
					...
					<div class="col-sm-4 col-padding" style="background: url('images/team/vicky2.jpg') center center no-repeat; background-size: cover;height: 440px !important;"></div>

					<div class="col-sm-8 col-padding">
						<div>
							<div class="heading-block">
								<span class="before-heading color">Owner &amp; Founder</span>
								<h3>Satyendra Kushwaha</h3>
								<p>Software Engineer | Photographer</p>
							</div>

									<p><b>Photography is a way of feeling, of touching, of loving. What you have caught on film is captured forever… It remembers little things, long after you have forgotten everything. Taking an image, freezing a moment, reveals how rich reality truly is.Photography is truth.</b></p>
									<p><b>Photography for me is not looking, it’s feeling. If you can’t feel what you’re looking at, then you’re never going to get others to feel anything when they look at your pictures. In photography there is a reality so subtle that it becomes more real than reality. The best thing about a picture is that it never changes, even when the people in it do. To me, photography is an art of observation. It’s about finding something interesting in an ordinary place… I’ve found it has little to do with the things you see and everything to do with the way you see them.</b></p>
									<h3>I don’t trust words. I trust pictures.</h3>
									
									<a href="http://www.facebook.com/iviicky" target="_blank" class="social-icon inline-block si-small si-light si-rounded si-facebook">
										<i class="icon-facebook"></i>
										<i class="icon-facebook"></i>
									</a>
									<a href="http://www.instagram.com/i_viicky" target="_blank" class="social-icon inline-block si-small si-light si-rounded si-instagram">
										<i class="icon-instagram"></i>
										<i class="icon-instagram"></i>
									</a>
									<a href="http://linkedin.com/in/satyendrakushwaha" target="_blank" class="social-icon inline-block si-small si-light si-rounded si-linkedin">
...
<!-- <div class="container common-height">
	...
	<div class="col-sm-5 col-padding" style="background: url('images/team/vicky2.jpg') center center no-repeat; background-size: cover;height: 440px !important;"></div>
...
<div class="container">
	<div class="row">
		<div class="col-md-12 common-height">
			<div class="col-md-4 col-padding" style="background: url('images/team/vicky2.jpg') center center no-repeat; background-size: cover;height: 440px !important;"></div>
	...
	<div class="section-nopadding heading-block center nobottomborder nobottommargin">
		<h2 style="margin:5px;">We don't take photographs, WE MAKE IT.</h2>
	</div>


	<div class="section-nopadding nobottommargin">
		...
		<div class="col_three_fifth nobottommargin col_last">
			...
			<div class="heading-block home-header">
				<h2>Shutter Up Films</h2>
			</div>

			<p>We believe that every moment is special – and not a single second should pass by without being treasured. Based in <b class="red">MUMBAI</b> but covering the almost <b class="red">METRO CITIES</b>, We bring a truly contemporary twist to photography. This isn’t about standing still and smiling for the camera; it’s fun, exciting and inspiring. It’s about enjoying good times with loved ones, taking a fresh look at the world, and enjoying beautiful photography which will awaken memories in your heart for a lifetime.</p>
			
			<div class="col_half">
				<ul class="iconlist iconlist-color">
					<li><i class="icon-caret-right"></i> High quality striking photographic images on brief, delivered and archived, reliably on tight deadlines.</li>
					<li><i class="icon-caret-right"></i> Ability to co-ordinate simultaneous shoots at sites around the country at a moments notice.</li>
					<li><i class="icon-caret-right"></i> Deliver initial images for press release purposes within a few hours of events conclusion.</li>
				</ul>
			</div>

			<div class="col_half col_last">
				<ul class="iconlist iconlist-color">
					<li><i class="icon-caret-right"></i>  Diverse capability to execute great photographic work requiring different specialities and skills seamlessly.</li>
					<li><i class="icon-caret-right"></i> 100% availability for clients on contract – support and shooting anywhere anytime.</li>
					<li><i class="icon-caret-right"></i> Input and consulting on creative conceptualisation and planning of photography projects.</li>
				</ul>
			</div>
		...
		<div class="container clearfix">
			...
			<ul id="portfolio-filter" class="portfolio-filter clearfix" data-container="#portfolio">
				...
				<li><a href="#" data-filter=".pf-icons">Portrait/Lifestyle photography</a></li>
				<li><a href="#" data-filter=".pf-illustrations">Commercial photography</a></li>
				<li><a href="#" data-filter=".pf-media">Event photography</a></li>
			...
			<div id="portfolio" class="portfolio grid-container portfolio-nomargin clearfix">
				...
				<article class="portfolio-item pf-icons">
					...
					<div class="portfolio-desc">
						<h3><a href="portfolio-single.html">People</a></h3>
						<span><a href="#">Portrait/Lifestyle photography</a></span>
					</div>
				</article>
				...
				<article class="portfolio-item pf-icons">
					...
					<div class="portfolio-desc">
						<h3><a href="portfolio-single-gallery.html">Pets</a></h3>
						<span><a href="#">Portrait/Lifestyle photography</a></span>
					</div>
				</article>
				...
				<article class="portfolio-item pf-illustrations">
					...
					<div class="portfolio-desc">
						<h3><a href="portfolio-single.html">Product</a></h3>
						<span><a href="#">Commercial photography</a></span>
					</div>
				</article>
				...
				<article class="portfolio-item pf-illustrations">
					...
					<div class="portfolio-desc">
						<h3><a href="portfolio-single.html">Food</a></h3>
						<span><a href="#">Commercial photography</a></span>
					</div>
				</article>
				...
				<article class="portfolio-item pf-illustrations">
					...
					<div class="portfolio-desc">
						<h3><a href="portfolio-single.html">Fashion</a></h3>
						<span><a href="#">Commercial photography</a></span>
					</div>
				</article>
				...
				<article class="portfolio-item pf-illustrations">
					...
					<div class="portfolio-desc">
						<h3><a href="portfolio-single.html">Industrial</a></h3>
						<span><a href="#">Commercial photography</a></span>
					</div>
				</article>
				...
				<article class="portfolio-item pf-illustrations">
					...
					<div class="portfolio-desc">
						<h3><a href="portfolio-single.html">Advertisement</a></h3>
						<span><a href="#">Commercial photography</a></span>
					</div>
				</article>
				...
				<article class="portfolio-item pf-media">
					...
					<div class="portfolio-desc">
						<h3><a href="portfolio-single.html">Special Occasions</a></h3>
						<span><a href="#">Event photography</a></span>
					</div>
				</article>
				...
				<article class="portfolio-item pf-media">
					...
					<div class="portfolio-desc">
						<h3><a href="portfolio-single-gallery.html">Corporate Events</a></h3>
						<span><a href="#">Event photography</a></span>
					</div>
				</article>
				...
				<article class="portfolio-item pf-media">
					...
					<div class="portfolio-desc">
						<h3><a href="portfolio-single.html">Sporting Events</a></h3>
						<span><a href="#">Event photography</a></span>
					</div>
				</article>
			</div><!-- #portfolio end -->
